...
class DB:
    ...
    def save_arbitrage_possibilities(self, ap : AP):
        ...
        message = {
            ...
            'max_buy_vol_usd': round(ap.buy_max_amount_ob * ap.buy_price),
            'max_sell_vol_usd': round(ap.sell_max_amount_ob * ap.sell_price),
            'expect_buy_price': ap.buy_price,
            'expect_sell_price': ap.sell_price,
            'expect_amount_usd': ap.deal_size_usd_final,
            'expect_amount_coin': ap.deal_size_amount_final,
            'expect_profit_usd': ap.expect_profit_usd_final,
            'expect_profit_relative': ap.expect_profit_rel_final,

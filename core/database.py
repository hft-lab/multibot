...
class DB:
    ...
    def save_arbitrage_possibilities(self, ap : AP):
        ...
        message = {
            ...
            'symbol': ap.coin,
            'buy_order_id': ap.buy_exchange_order_id,
            'sell_order_id': ap.sell_exchange_order_id,
            'max_buy_vol_usd': round(ap.buy_max_amount_final * ap.buy_price),
            'max_sell_vol_usd': round(ap.sell_max_amount_final * ap.sell_price),
